      ...
      {isLoading ? (
        ...
        <Stack spacing={3}>
          <Grid container spacing={2}>
            <Grid size={{ xs: 6, lg: 3 }}>
              <StatCard label="Revenue pipeline" icon={PaidOutlined} value={formatCurrency(sumBy(data?.leaderboard, 'revenueWon'))} />
            </Grid>
            <Grid size={{ xs: 6, lg: 3 }}>
              <StatCard label="Conversion rate" icon={TrendingUpOutlined} value={`${data?.conversionRate ?? 0}%`} />
            </Grid>
            <Grid size={{ xs: 6, lg: 3 }}>
              <StatCard label="Won this month" icon={EmojiEventsOutlined} value={sumBy(data?.leaderboard, 'clientsWon')} />
            </Grid>
            <Grid size={{ xs: 6, lg: 3 }}>
              <StatCard label="Executives" icon={GroupsOutlined} value={data?.leaderboard?.length ?? 0} />
            </Grid>
          </Grid>
          ...
          <Grid container spacing={3}>
            ...
            <Grid size={{ xs: 12, lg: 6 }}>
              <Card>
                <CardContent>
                  <SectionHeading icon={LeaderboardOutlined}>Executive leaderboard</SectionHeading>
                  <Stack spacing={1.5}>
